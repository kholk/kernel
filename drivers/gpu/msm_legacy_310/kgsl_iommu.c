		...
		enum kgsl_iommu_context_id id, enum kgsl_iommu_reg_map reg)
{
	...
	if (iommu->iommu_reg_list[reg].ctx_reg) {
		pr_err("******************************************************************************\n");
		pr_err("ahb_base_offset: 0x%x, reg_offset: 0x%x, ctx_id: 0x%x, ctx_ahb_offset: 0x%x\n",
			iommu->ahb_base_offset, iommu->iommu_reg_list[reg].reg_offset,
			ctx_id, iommu->ctx_ahb_offset);
		pr_err("******************************************************************************\n");
		...
		pr_err("******************************************************************************\n");
		pr_err("ahb_base_offset: 0x%x, reg_offset: 0x%x\n",
			iommu->ahb_base_offset, iommu->iommu_reg_list[reg].reg_offset);
		pr_err("******************************************************************************\n");
		return iommu->ahb_base_offset +
			iommu->iommu_reg_list[reg].reg_offset;
