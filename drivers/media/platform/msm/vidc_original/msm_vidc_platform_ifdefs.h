...
/* VDEC ifdefs */
    ...
    !defined(CONFIG_ARCH_MSM8998) && !defined(CONFIG_ARCH_SDM630) && \
    !defined(CONFIG_ARCH_SDM845)
	#define VDEC_H264_LEVEL_6_2_AVAILABLE
...
#ifdef VDEC_H264_LEVEL_6_2_AVAILABLE
 #define VDEC_H264_PLATFORM_MAX_LEVEL	V4L2_MPEG_VIDEO_H264_LEVEL_6_2
#else
 #define VDEC_H264_PLATFORM_MAX_LEVEL	V4L2_MPEG_VIDEO_H264_LEVEL_5_2
#endif
